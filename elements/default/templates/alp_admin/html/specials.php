			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0" class="list_table">
				...
				<tr>
					...
					<table width='100%' border='0' cellspacing='0' cellpadding='0'>
                      ...
                      <tr> 
                        <td colspan='2' class='text_grey'>
                        <img src='elements<?php echo PATH_SEP; ?>default<?php echo PATH_SEP; ?>templates<?php echo PATH_SEP; ?>alp_admin<?php echo PATH_SEP; ?>images<?php echo PATH_SEP; ?>menu_line_lightgreen-long.jpg' width='100%' height='2' />
                        </td>
                      </tr>
