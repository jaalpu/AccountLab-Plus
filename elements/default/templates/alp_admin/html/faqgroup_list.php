			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0" class="list_table">
		          ...
		          <?php } else { ?>
					...
					<td class='text_grey' width="1%"></td>
                      ...
                      <a href='<?php echo $PHP_SELF; ?>?cmd=editfaqgroup&faqgroup_id=<?php echo $val['faqgroup_id']; ?>'><img src='elements<?php echo PATH_SEP; ?>default<?php echo PATH_SEP; ?>templates<?php echo PATH_SEP; ?>alp_admin<?php echo PATH_SEP; ?>images<?php echo PATH_SEP; ?>edit_all.gif' alt='<?php echo $BL->props->lang['Edit']; ?>' border='0'></a>
                      &nbsp;
                      <?php } ?>                      
                      <?php if($BL->getCmd("delfaqgroup")){ ?>
                      <a href="javascript:if(confirm('<?php echo $BL->props->lang['Do_you_want_to_delete_this_faqgroup']; ?>'))document.location='<?php echo $PHP_SELF; ?>?cmd=delfaqgroup&faqgroup_id=<?php echo $val['faqgroup_id']; ?>'"><img src='elements<?php echo PATH_SEP; ?>default<?php echo PATH_SEP; ?>templates<?php echo PATH_SEP; ?>alp_admin<?php echo PATH_SEP; ?>images<?php echo PATH_SEP; ?>delete.gif' alt='<?php echo $BL->props->lang['Delete']."?"; ?>' border='0'></a>
                      &nbsp;
                      <?php } ?>
                      </div></td>
                    </tr>
